...
const getmovie = async (type) => {
    try {
        lasturl = type;
        const config = { params: { sort_by: 'popularity.desc', api_key: '7b4fdab06810dcb18c525475eae2415f', with_genres: selectgenres.join(), page: cur } }
...
function addmovie(movies) {
    ...
    <div class="desc">
        ...
        ${movie.overview}
        <br>
        <button type="button" class="btn btn-danger btn-lg know-more" id="${movie.id}">Know more</button>
    </div>`
        main.append(d);
